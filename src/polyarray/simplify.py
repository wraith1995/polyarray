...
def _symarray_atoms(sa: SymArray) -> set[str]:
    """Return the run-time binding keys a SymArray reads.

    Either its bulk name, or its cells' rational-function generators — the keys
    :meth:`SymArray.evaluate` resolves.
    """
